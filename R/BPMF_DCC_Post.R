...
load("../data/4k_it_MAE_vec.rda")
plot(2:(length(MAE_vec)+1),MAE_vec, type= "l",col = "red",
     xlab = "D",ylab = "MAE")
load("../data/4k_it_demean_MAE_vec.rda")
lines(2:(length(MAE_vec)+1),MAE_vec, col = "blue")
load("../data/4k_it_demed_MAE_vec.rda")
...
load("../data/4k_it_demean_kmean_MAE_vec.rda")
lines(2:(length(MAE_vec)+1),MAE_vec, col = "blue")
load("../data/4k_it_demean_kmean_item_const_MAE_vec.rda")
lines(2:(length(MAE_vec)+1),MAE_vec, col = "green")
...
load("../data/4k_it_demean_kmean_rMSE_vec.rda")
...
load("../data/4k_it_demean_BBMMBPMF_MAE_vec.rda")
lines(2:(length(MAE_vec)+1),MAE_vec, col = "blue")
#plot MAE from kmean BPMF
load("../data/4k_it_demean_kmean_MAE_vec.rda")
lines(2:(length(MAE_vec)+1),MAE_vec, col = "green")
#plot MAE from kmean BPMF with fake cluster
load("../data/4k_it_demean_K_2_rand_BPMF_MAE_vec.rda")
